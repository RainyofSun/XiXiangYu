//
//  XYSelectedCityViewController.m
//  Xiangyu
//
...
@interface XYSelectedCityViewController ()<UITextFieldDelegate>
@property (nonatomic, strong) UIView *naviView;
@property (nonatomic, strong) UITextField *searchBar;
@property (nonatomic, strong) UIButton *cancelBtn;

@property(nonatomic,strong)XYDoubleTableView* mainView;
@property(nonatomic,strong)XYSearchCityView *searchView;
@end

@implementation XYSelectedCityViewController
...
-(XYDoubleTableView *)mainView{
  if (!_mainView) {
    _mainView = [[XYDoubleTableView alloc]initWithFrame:CGRectZero];
    @weakify(self);
