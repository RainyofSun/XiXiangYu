...
@class XYSecurityPolicy;
@class XYBaseAPI;
@protocol XYRPCProtocol;

NS_ASSUME_NONNULL_BEGIN

#pragma mark -
@protocol XYMultipartFormData
...
#pragma mark -
@protocol XYHttpHeaderDelegate <NSObject>
 ...
 *  用于组织POST体的block
 */
@property (nonatomic, copy, nullable) void (^apiRequestConstructingBodyBlock)(id<XYMultipartFormData> _Nonnull formData);
 ...
 *  error:  api 返回的错误信息
 */
@property (nonatomic, copy, nullable) void (^filterCompletionHandler)(_Nullable id data, XYError * _Nullable error);
 ...
 */
@property (nonatomic, weak, nullable) id<XYRPCProtocol> rpcDelegate;

/**
 *  HTTPHeader Field Delegate
 */
@property (nonatomic, weak, nullable) id<XYHttpHeaderDelegate> apiHttpHeaderDelegate;
 ...
 *  @param error          请求的错误
 *
 *  @return 默认返回responseObject中bizdata中的data
 */
 ...
 *  @param responseObject 请求的返回
 *
 *  @return 默认返回responseObject中的code和msg
 */
 ...
 *  请求的类型:GET, POST
 *  @default
 *   XYRequestMethodTypePost
 *
 *  @return XYRequestMethodType
 */
- (XYRequestMethodType)apiRequestMethodType;

/**
 *  Request 序列化类型：JSON, HTTP, 见XYRequestSerializerType
 *  @default
 *   XYResponseSerializerTypeJSON
 *
 *  @return XYRequestSerializerTYPE
 */
 ...
 *
 *  @return XYResponseSerializerType
 */
