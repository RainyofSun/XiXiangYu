...
- (void)configUI {
    ...
    titleLabel.textColor = ColorHex(XYTextColor_999999);
    [self.contentView addSubview:titleLabel];
    self.titlelabel = titleLabel;
    
    UILabel *descLabel = [[UILabel alloc] init];
    descLabel.font = [UIFont systemFontOfSize:12];
  descLabel.textColor = ColorHex(XYTextColor_CCCCCC);
...
- (void)layoutSubviews {
    ...
    self.titlelabel.frame = CGRectMake(leftMargin, self.iconImageView.frame.origin.y + 5, kScreenWidth - leftMargin - 10, 20);
    self.descLabel.frame = CGRectMake(leftMargin, CGRectGetMaxY(self.titlelabel.frame) + 10, kScreenWidth - leftMargin - 10, 20);
}
