...
- (void)configUI {
    ...
    self.label.textColor = ColorHex(XYTextColor_999999);
    ...
    deleteBtn.frame = CGRectMake(kScreenWidth - 30 - 10, 30, 30, 30);
...
- (void)layoutSubviews {
    self.label.frame = CGRectMake(20, 30, kScreenWidth - 40, 20);
}
