 ...
 */
@interface XYRangeSliderLeftElement : UIAccessibilityElement
@end

/**
 An accessibility element that increments and decrements the right slider
 */
@interface XYRangeSliderRightElement : UIAccessibilityElement
@end
...
{
  XYRangeSliderLeftElement *element = [[XYRangeSliderLeftElement alloc] initWithAccessibilityContainer:self];
...
{
  XYRangeSliderRightElement *element = [[XYRangeSliderRightElement alloc] initWithAccessibilityContainer:self];
  element.isAccessibilityElement = YES;
...
@implementation XYRangeSliderLeftElement

- (void)accessibilityIncrement {
  XYRangeSlider* slider = (XYRangeSlider*)self.accessibilityContainer;
...
@implementation XYRangeSliderRightElement
