...
#import "XYRangeSliderDelegate.h"

IB_DESIGNABLE
@interface XYRangeSlider : UIControl <UIGestureRecognizerDelegate>

/**
 * Optional delegate.
 */
@property (nonatomic, weak) IBOutlet id<XYRangeSliderDelegate> delegate;
