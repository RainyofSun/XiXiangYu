...
{
    return [[XYFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XYFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XYFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XYFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XYFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[XYFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
