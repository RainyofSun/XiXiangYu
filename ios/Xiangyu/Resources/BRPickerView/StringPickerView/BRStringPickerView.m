...
+ (void)showPickerWithTitle:(nullable NSString *)title
    ...
    [self showPickerWithTitle:title dataSourceArr:dataSourceArr selectValue:selectValue isAutoSelect:NO resultBlock:resultBlock];
}
...
+ (void)showPickerWithTitle:(nullable NSString *)title
    ...
    strPickerView.title = title;
    strPickerView.dataSourceArr = dataSourceArr;
    strPickerView.selectValue = selectValue;
    strPickerView.isAutoSelect = isAutoSelect;
    strPickerView.resultModelBlock = resultBlock;
 ...
 *  @param selectValues        默认选中的位置（传索引数组，如：@[@2, @1]）
 *  @param resultBlock         选择后的回调
 *
 */
+ (void)showMultiPickerWithTitle:(nullable NSString *)title
                   dataSourceArr:(nullable NSArray *)dataSourceArr
                    selectValues:(nullable NSArray <NSString *> *)selectValues
                     resultBlock:(nullable BRStringResultModelArrayBlock)resultBlock{
    [self showMultiPickerWithTitle:title dataSourceArr:dataSourceArr selectValues:selectValues isAutoSelect:NO resultBlock:resultBlock];
}
...
+ (void)showMultiPickerWithTitle:(nullable NSString *)title
    ...
    strPickerView.title = title;
    strPickerView.dataSourceArr = dataSourceArr;
    strPickerView.selectValues = selectValues;
    strPickerView.isAutoSelect = isAutoSelect;
    strPickerView.resultModelArrayBlock = resultBlock;
