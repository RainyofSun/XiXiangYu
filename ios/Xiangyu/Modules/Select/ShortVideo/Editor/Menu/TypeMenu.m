...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextMoveToPoint(context, rect.size.width*0.8, 0);//设置起始位置
    CGContextAddLineToPoint(context,rect.size.width*0.7-10, 10);//从起始位置到这个点连线
    CGContextAddLineToPoint(context,rect.size.width*0.7+10, 10);
