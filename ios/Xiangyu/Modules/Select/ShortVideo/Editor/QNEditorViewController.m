...
- (void)setupTopBar {
    ...
    UIButton *nextButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 160, 44)];;
    nextButton.backgroundColor = ColorHex(@"#F92B5E");
...
//    }];
    ...
    self.rightScrollView = scrollView;
    scrollView.showsHorizontalScrollIndicator = NO;
    [self.rightBarView addSubview:scrollView];
    [scrollView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.top.bottom.equalTo(self.rightBarView);
  ...
  [scrollView addSubview:containerView];
    ...
    UIButton* buttons[9];
//    NSString *titles[] = { @"动图", @"MV", @"涂鸦", @"文字", @"音乐", @"音量", @"滤镜"
//    };
  NSString *titles[] = {  @"涂鸦", @"文字",  @"音量", @"滤镜"
  };
    
//    NSString *imageNames[] = { @"qn_gif", @"qn_mv", @"qn_tuya", @"qn_text", @"qn_music", @"qn_volume", @"qn_filter"
//    };
  NSString *imageNames[] = {@"qn_tuya", @"qn_text", @"qn_volume", @"qn_filter"
  };
...
//        @selector(clickMusicButton:),
    ...
    [containerView makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(count * (height + space) + 2 * space);
    }];
    
    NSArray *array = [NSArray arrayWithObjects:buttons count:count];
    [array mas_distributeViewsAlongAxis:(MASAxisTypeVertical) withFixedSpacing:space leadSpacing:space tailSpacing:space];
