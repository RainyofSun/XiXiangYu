...
- (void)setupToolboxUI {
    ...
    self.baseToolboxView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, PLS_SCREEN_WIDTH, NAVBAR_HEIGHT)];
    ...
    [backButton setImage:[UIImage imageNamed:@"qn_icon_close"] forState:UIControlStateHighlighted];
    [backButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [backButton setTitleColor:PLS_RGBCOLOR(141, 141, 142) forState:UIControlStateHighlighted];
    backButton.frame = CGRectMake(0, NAVBAR_HEIGHT - 44, 80, 44);
...
//    self.uploadButton.frame = CGRectMake(PLS_SCREEN_WIDTH - 80, NAVBAR_HEIGHT - 44, 80, 44);
...
- (void)setupPlayerUI {
    ...
    self.duration.text = [NSString stringWithFormat:@"%.2fs", CMTimeGetSeconds(self.player.currentItem.duration)];
...
- (void)initPlayer {
    ...
    self.playerView = [[PLSPlayerView alloc] initWithFrame:CGRectMake(0, 0, PLS_SCREEN_WIDTH, PLS_SCREEN_HEIGHT)];
...
//    getVideoPreViewImage
  XYReleaseVideoVC *vc = [[XYReleaseVideoVC alloc] init];
  vc.urlString = urlString;
  vc.onePreImage = [self getLocationVideoPreViewImage:_url];
